...
if(line=="break"){break;}                               //Wpisanie elementow do tablicy o nieokreslonej dlugosci
...
{
casen(input);std::cout<<"\n";
}
}else std::cerr<<"Za malo danych!\n";
return 0;
}
